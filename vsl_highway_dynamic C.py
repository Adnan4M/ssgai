...
# --- SCENARIO C PARAMETERS: ADVERSE COMMUNICATIONS ---
# Set both to 0 to run this as "Scenario B" (normal comms) instead.
PACKET_LOSS_RATE = 0.50              # 50% chance of RSU token being lost
MAX_LATENCY_STEPS = 5                # Max delay in steps (seconds) for successful packet
